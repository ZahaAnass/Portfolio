        ...
        <div className='mb-6'>
            <div className='flex items-start space-x-6 bg-blue-950/20 transition-all duration-300 p-4 sm:p-8 rounded-md'>
                ...
                <div className='flex-1'>
                    {date && (
                        <h1 className='mb-3 sm:px-6 sm:py-1.5 px-4 py-1 rounded-full bg-gray-200 text-gray-600 w-fit sm:text-lg text-sm font-bold'>
                            {date}
                        </h1>
                    )}
                    ...
                    <p className='text-gray-300 text-sm sm:text-base pt-3'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat fugiat voluptatibus cum 
                        reiciendis ab? Ipsam fugit facilis voluptas itaque architecto distinctio iste eos. 
                        Facere id officiis doloremque optio nostrum dicta.
                    </p>
                </div>
            </div>
        </div>
